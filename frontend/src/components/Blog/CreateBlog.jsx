...
import { toast } from "react-toastify"; // optional if you use toast

const CreateBlog = ({ onPost }) => {
  ...
  // Only allow Job Seeker or Employer
  const canPost = user && (user.role === "Job Seeker" || user.role === "Employer");
          ...
          {showModal && (
            ...
            >
              ...
              >
                ...
                <h2 style={{ textAlign: "center", marginBottom: 24, color: "#000000ff" }}>
                  Your Experience
                </h2>
